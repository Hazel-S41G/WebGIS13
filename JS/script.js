...
var baseMapGoogleSat = L.tileLayer('https://{s}.googleapis.com/vt/lyrs=s&x={x}&y={y}&z={z}', {
    maxZoom: 20,
        attribution: 'Imagery © <a href="https://www.google.com/earth/">Google</a>',
        subdomains: ['mt0', 'mt1', 'mt2', 'mt3']
        });

var baseMapEsriDarkGray = L.tileLayer(
...
map.addControl( 
    ...
    var jembatanPT = new L.LayerGroup(); 
            $.getJSON("Asset/jembatan_pt.geojson", function (OBJECTID) {
                L.geoJSON(OBJECTID, { 
        ...
        $.getJSON("Asset/admin_kelurahan_ln.geojson", function (OBJECTID) { 
        ...
        $.getJSON("Asset/landcover_ar.geojson", function (REMARK) {
            L.geoJson(REMARK, { 
        ...
        var baseMaps = { 
            ...
            "Satellite" : baseMapGoogleSat,
            "Dark Grey" : baseMapEsriDarkGray
        }; 
